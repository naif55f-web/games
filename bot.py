...
async def cmd_mafia(ctx):
    ...
    await ctx.send(f"🔒 **تم توزيع الأدوار سراً!** عدد اللاعبين المشاركين: {len(participants)}.")
    ...
    doctor_target = doc_session.selected_target
    ...
    mafia_target = maf_session.selected_target
